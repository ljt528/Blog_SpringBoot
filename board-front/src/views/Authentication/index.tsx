...
export default function Authentication() {
    ...
    //          state : 화면 상태           //
    // sign-in과 sign-up의 리터럴(값)만 가질 수 있게 설정
  ...
  const SignUpCard = () => {
    ...
    const onNextButtonClickHandler = () => {
      // 정규표현식 사용
      // 이메일 패턴 : a-z까지 A-Z까지 0-9까지 몇 개가 들어오든 상관X, @가 들어온 후 -또는.이 올 수도 있고 안 올 수도 있음, a-z까지 A-Z까지 0-9까지 몇 개가 들어오든 상관X, a-z까지 A-Z까지 2 ~ 4개 올 수 있음
    ...
    const onSignUpButtonClickHandler = () => {
      ...
      // 정상적인 동작을 할 경우 필요없지만 동작 중 상태가 오류가 발생할 수 있으므로 막아주기 위해 작성
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'JunTae Blog'}</div>
            </div>
          </div>
        </div>
